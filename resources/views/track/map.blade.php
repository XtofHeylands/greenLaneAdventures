...
<html>
<head>
    <title>GPS Visualizer PHP dynamic map example</title>
...
<script type="text/javascript">
    /* Global variables used by the GPS Visualizer functions (20200511135109): */
    gv_options = {};
    ...
    gv_options.profile_options = { visible:false, icon:true, units:'us', filled:true, y_min:null, y_max:null, height:120, width:690, gap_between_tracks:false, waypoints:false }; // see https://www.gpsvisualizer.com/tutorials/profiles_in_maps.html
    ...
    if (document.location.protocol == 'https:') { // secure pages require secure scripts
        ...
        document.writeln('<script src='+script_file+'"/" type="text/javascript"><'+'/script>');
    }
</script>
<style type="text/css">
...
<script type="text/javascript">
    function GV_Map() {
        ...
        <?php
        $path_to_tracks = 'public/storage/gpx';
        if ($_REQUEST['track']) {
    ...
    // https://www.gpsvisualizer.com/map_input?form=html&units=us
</script>
